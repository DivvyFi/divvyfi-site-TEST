...
// import Features from "./components/home/features"; // removed
import FeaturedAssets from "./components/home/featured-assets"; // NEW
              ...
              <div className='grid grid-cols-1 lg:grid-cols-12 my-16 items-center'>
                ...
                <div className='lg:col-span-7 mb-16'>
                  <h1 className='mb-5 lg:text-start text-center sm:leading-snug leading-tight'>
                    DeFi with DivvyFi. <br /> Real Assets, <br /> Reinvented Ownership.
                  </h1>
